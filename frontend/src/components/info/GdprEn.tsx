        ...
        <>
            ...
            <div className="container login-margin-top-90 wrapper mb-4">
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Euromed eu trade s.r.o, 2725/14 Jindřicha Jindřicha 15500 Praha.</p>
                    ...
                    <li>
                        <p><strong>Website</strong> refers to Prádelna1, accessible from <a href="https://pradelna1.cz/" rel="external nofollow noopener" target="_blank">https://pradelna1.cz/</a></p>
                    </li>
                    <li>
                ...
                <ul>
                    <li>By email: office@pradelna1.com</li>
                </ul>
                ...
                {/*                <span style={{ marginLeft: "5px" }}>{currentData?.buttons?.download || "Download"}{" "}*/}
            ...
            {/*    >*/}
            {/*        <FontAwesomeIcon icon={faFilePdf} className="file-uploaded" />*/}
            {/*        <span style={{ marginLeft: "5px" }}>{currentData?.buttons?.download || "Download"}{" "}PDF</span>*/}
            {/*    </a>*/}
            {/*</div>*/}
        </>
    );
