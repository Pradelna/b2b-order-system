...
class LandingPage(models.Model):
    ...
    order_every_day = models.CharField("Every work day", max_length=100, blank=True, null=True)
    order_every_day_with_weekend = models.CharField("Every day with weekend", max_length=100, blank=True, null=True)
